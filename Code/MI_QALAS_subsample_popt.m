...
%% Optimization
tic;
[popt,fval,exitflag,output,lambda,grad,hessian]=fmincon(@(x) MI_QALAS_objfun_nd_subsample(x,pspacelabels,subsmpllabels,tisinput,acqparam,materialID,optcase,geometryflag,B1inhomflag),...
