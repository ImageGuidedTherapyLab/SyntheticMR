...
function [popt] = MI_GHQuad_3DQALAS_driver(acqparam,tisinput,materialID)
...
%             pinit=tconstrain/4*ones([4,1]);
            ...
            tolx=1.e-3;%1.e-5;
            tolfun=1.e-3;%1.e-5;QALAS_synphan_MIcalc.m
            maxiter=500;
...
%         end
        ...
        tic;
        [popt,fval,exitflag,output,lambda,grad,hessian]=fmincon(@(x) MI_GHQuad_3DQALAS(x,tisinput,acqparam,materialID),...
