...
function [] = QALAS_synphan_MIcalc(tconoverride,acqtimes,pdvval,runnumber,geometrycase)
...
%         geometrycase=2;
    ...
    %         pinit=[4,1,1,1,1]';
        ...
        tic;
        [popt,fval,exitflag,output,lambda,grad,hessian]=fmincon(@(x) QALAS_synphan_MIcalc_objfun(x,pspacelabels,subsmpllabels,tisinput,synthdataT1,synthdataT2,synthdataM0,noise,acqparam,materialID,pdarg,B1inhomflag,filenametmp),...
