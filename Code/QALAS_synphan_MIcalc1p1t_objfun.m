...
function [MI]=QALAS_synphan_MIcalc1p1t_objfun(scanArchivePath,fileflag,paraminput,tisid)
...
[x,xn,xm,w,wn]=GaussHermiteNDGauss(NumQP,paraminput(tisid),paraminput(tisid+3));
