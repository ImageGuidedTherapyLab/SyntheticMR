...
%         optcaseacc=[1,2,3,4,100];
        optcaseacc=[1,1,1,1,1];
        optcasevar=[1,3,10,20,25];
        geometrycase=2;
...
%             dt=[0,0,Tacq,TDpT2,0,TDinv,Tacq,TD(1),Tacq,TD(2),Tacq,TD(3),Tacq,TD(4)];
        ...
        filenametmp='/rsrch1/ip/dmitchell2/github/SyntheticMR/Code/MI_QALAS_subsample_poptreconstmp2.mat';
        ...
        [popt,fval,exitflag,output,lambda,grad,hessian] = MI_QALAS_subsample_popt...
            (optcase,geometrycase,B1inhomflag,pspacelabels,subsmpllabels,acqparam,pinit,pAeq,pbeq,pmin,pmax,findiffrelstep,tolx,tolfun,maxiter,filenametmp);
        %         toc;
        ...
        system(sprintf('mv %s /rsrch1/ip/dmitchell2/github/SyntheticMR/Code/results/MI_QALAS_subsample_poptrecons_%f_%f.mat',filenametmp,ttotal,optcase));
        %     catch
        %     end
