...
subplot(3,3,1);
boxplot(M0v(1:14,:)','Positions',1:14);
xlabel('PD Element Number'); ylabel('M0'); title('M0'); pause(1);
subplot(3,3,2);
boxplot(T1v(1:14,:)','Positions',1:14);
xlabel('PD Element Number'); ylabel('T1 (s)'); title('T1'); pause(1);
subplot(3,3,3);
boxplot(real(T2v(1:14,:))','Positions',1:14);
xlabel('PD Element Number'); ylabel('T2 (s)'); title('T2'); pause(1);
axis([0,15,0,2]);

subplot(3,3,4);
boxplot(M0v(15:28,:)','Positions',1:14);
xlabel('T1 Element Number'); ylabel('M0'); pause(1);
subplot(3,3,5); hold on;
boxplot(T1v(15:28,:)','Positions',1:14);
plot(phantomProp.T1element.T30.T1./1000,'gx');
legend('True Value');
xlabel('T1 Element Number'); ylabel('T1 (s)'); pause(1);
subplot(3,3,6); hold on;
boxplot(real(T2v(15:28,:))','Positions',1:14);
plot(phantomProp.T1element.T30.T2./1000,'gx');
legend('True Value');
xlabel('T1 Element Number'); ylabel('T2 (s)'); pause(1);
axis([0,15,0,2]);

subplot(3,3,7);
boxplot(M0v(29:42,:)','Positions',1:14);
xlabel('T2 Element Number'); ylabel('M0'); pause(1);
subplot(3,3,8); hold on;
boxplot(T1v(29:42,:)','Positions',1:14);
plot(phantomProp.T2element.T30.T1./1000,'gx');
legend('True Value');
xlabel('T2 Element Number'); ylabel('T1 (s)'); pause(1);
subplot(3,3,9); hold on;
boxplot(real(T2v(29:42,:))','Positions',1:14);
plot(phantomProp.T2element.T30.T2./1000,'gx');
legend('True Value');
xlabel('T2 Element Number'); ylabel('T2 (s)'); pause(1);
axis([0,15,0,2]);
