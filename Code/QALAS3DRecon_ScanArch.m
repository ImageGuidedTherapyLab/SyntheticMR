...
figure;
boxplot(T2v(1:14,:)','Positions',1:14);
...
figure; hold on;
boxplot(T2v(15:28,:)','Positions',1:14);
...
figure; hold on;
boxplot(T2v(29:42,:)','Positions',1:14);
...
figure;
for iii=1:14
    subplot(2,7,iii); boxplot(cat(1,M1v(iii,:),M2v(iii,:),M3v(iii,:),M4v(iii,:),M5v(iii,:))','Positions',csdt([2,6:2:end-1]));%({'M1','M2','M3','M4','M5'});
    xticklabels(strtrim(cellstr(num2str(csdt([2,6:2:end-1]),'%2.1f\n'))));
    title(['PD Elem ',num2str(iii)]);
end
figure;
for iii=15:28
    subplot(2,7,iii-14); boxplot(cat(1,M1v(iii,:),M2v(iii,:),M3v(iii,:),M4v(iii,:),M5v(iii,:))','Positions',csdt([2,6:2:end-1]));
    xticklabels(strtrim(cellstr(num2str(csdt([2,6:2:end-1]),'%2.1f\n'))));
    title(['TD1 Elem ',num2str(iii-14)]);
end
figure;
for iii=29:42
    subplot(2,7,iii-28); boxplot(cat(1,M1v(iii,:),M2v(iii,:),M3v(iii,:),M4v(iii,:),M5v(iii,:))','Positions',csdt([2,6:2:end-1]));
    xticklabels(strtrim(cellstr(num2str(csdt([2,6:2:end-1]),'%2.1f\n'))));
