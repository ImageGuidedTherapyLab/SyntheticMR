...
%             titlename=sprintf('Gray Matter, TD4=%2.2f, SS=%2.2f',TD4in(iii),subsampin(jjj));
            titlename1=sprintf('GM %2.2f TD=[%2.2f,%2.2f,%2.2f,%2.2f]',subsampin(jjj),TD(1),TD(2),TD(3),TD(4));
            titlename2=sprintf('var=[%2.5f,%2.5f,%2.5f] MI=%5.4e MI_n=%5.4e',varcell{iii,jjj}(1,1),varcell{iii,jjj}(2,1),varcell{iii,jjj}(3,1),-MIobjfun{iii,jjj},-MIobjfun_n{iii,jjj});
            figure; hold on;
            ...
            xlabel('Time (s)'); ylabel('M'); title({titlename1;titlename2},'FontSize',9);
            
%             titlename=sprintf('White Matter, TD4=%2.2f, SS=%2.2f',TD4in(iii),subsampin(jjj));
            titlename1=sprintf('WM %2.2f TD=[%2.2f,%2.2f,%2.2f,%2.2f]',subsampin(jjj),TD(1),TD(2),TD(3),TD(4));
            titlename2=sprintf('var=[%2.5f,%2.5f,%2.5f] MI=%5.4e MI_n=%5.4e',varcell{iii,jjj}(1,1),varcell{iii,jjj}(2,1),varcell{iii,jjj}(3,1),-MIobjfun{iii,jjj},-MIobjfun_n{iii,jjj});
            figure; hold on;
