...
Score function~\cite{seeger2010optimization}
\[
 S = \mathcal{H}( P (u|z)) - E_{P(\tilde{z}|z)} \left[ \mathcal{H}(P(u|z,\tilde{z}))\right]
\]
 \[
  \mathcal{H}( P (u|z)) = \mathcal{H}( P (u,z)) - \mathcal{H}( P (z)) 
 \]
...
\[
\mathcal{H}(P(u|z,\tilde{z}))  = 
\mathcal{H}(P(u,z,\tilde{z}))  - \mathcal{H}(P(z,\tilde{z}))  
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
